        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;">
          ...
          <tr>
            <td align="center" style="padding-bottom:32px;">
              ...
              <p style="margin:8px 0 0;color:#FF2E00;font-size:20px;font-weight:700;letter-spacing:0.05em;">TABEZA</p>
            </td>
          </tr>

          <tr>
            <td style="background-color:#131009;border:1px solid rgba(255,46,0,0.18);border-radius:16px;padding:40px 36px;">
              ...
              <p style="margin:0 0 16px;color:#7A6A54;font-size:15px;line-height:1.6;">
                <strong style="color:#FF2E00;">${inviterName}</strong> nominated <strong style="color:#F0E8D8;">${venueName}</strong> to join Tabeza — Kenya's digital tab management platform.
              </p>
              ...
              <a href="https://tabeza.co.ke"
                 style="display:inline-block;background-color:#FF2E00;color:#0C0907;text-decoration:none;font-size:15px;font-weight:700;padding:14px 32px;border-radius:8px;letter-spacing:0.02em;">
                Learn more at tabeza.co.ke →
              </a>

              <p style="margin:24px 0 0;color:#5A4A38;font-size:13px;line-height:1.6;">
                Questions? Email us at <a href="mailto:support@tabeza.co.ke" style="color:#FF2E00;text-decoration:none;">support@tabeza.co.ke</a>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding-top:24px;">
              <p style="margin:0;color:#5A4A38;font-size:12px;">
                © Tabeza · <a href="https://tabeza.co.ke" style="color:#FF2E00;text-decoration:none;">tabeza.co.ke</a>
              </p>
            </td>
          </tr>

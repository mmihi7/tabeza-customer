 ...
 */
function getUserFriendlyMessage(errorInfo, context) {
 ...
 */
function shouldRetryError(errorInfo) {
    if (!errorInfo.code)
        return false;
 ...
 */
function logError(error, operationName, attempt, context) {
    const logData = {
 ...
 */
export async function withDatabaseErrorHandling(operation, options = {}) {
 ...
 */
export async function withOnboardingErrorHandling(operation, operationName, context) {
 ...
 */
export async function withVenueConfigErrorHandling(operation, operationName, context) {
    return withDatabaseErrorHandling(operation, {
 ...
 */
export async function withMigrationErrorHandling(operation, operationName, context) {
    return withDatabaseErrorHandling(operation, {
 ...
 */
export function createUserErrorMessage(result, fallbackMessage = 'An error occurred. Please try again.') {
    if (result.success)
        return '';

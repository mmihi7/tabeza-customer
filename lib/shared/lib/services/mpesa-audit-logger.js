...
export class MpesaAuditLogger {
     ...
     */
    async logPaymentEvent(action, data, additionalContext) {
        try {
    ...
    redactSensitiveData(data) {
        ...
        if (redacted.callback_data?.Body?.stkCallback?.CallbackMetadata?.Item) {
            ...
            redacted.callback_data.Body.stkCallback.CallbackMetadata.Item = items.map((item) => {
...
export function getMpesaAuditLogger() {
 ...
 */
export async function logMpesaPaymentEvent(action, data, additionalContext) {
 ...
 */
export async function logMpesaStateTransition(data) {
    const logger = getMpesaAuditLogger();

...
const MockNetworkStatusManager = NetworkStatusManager;
describe('RetryQueueManager', () => {
    ...
    describe('queue processing', () => {
        ...
        it('should handle missing handlers gracefully', async () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith('No handler registered for operation type: unknown_operation');
    ...
    describe('persistence', () => {
        it('should persist queue to localStorage', () => {
            ...
            expect(mockLocalStorage.setItem).toHaveBeenCalledWith('tabeza_retry_queue', expect.stringContaining('test_operation'));
            persistentManager.destroy();
        });
...
describe('Global retry queue functions', () => {
    beforeEach(() => {
        ...
        if (global.globalRetryQueue) {
            global.globalRetryQueue = null;
        }
    });

 ...
 * Requirements: 7.5
 */
import { ConfigurationHistoryService, getConfigurationHistoryService } from '../configuration-history';
// Mock Supabase
const mockSupabase = {
    from: jest.fn(() => ({
        select: jest.fn(() => ({
...
describe('ConfigurationHistoryService', () => {
    ...
    describe('formatHistoryEntry', () => {
        it('should format onboarding completion entry correctly', () => {
            ...
            const formatted = service.formatHistoryEntry(entry);
    ...
    describe('formatConfiguration', () => {
        it('should format configuration object correctly', () => {
            ...
            const formatted = service.formatConfiguration(config);
    ...
    describe('formatUserAgent', () => {
        it('should extract browser and OS information', () => {
            ...
            const formatted = service.formatUserAgent(userAgent);

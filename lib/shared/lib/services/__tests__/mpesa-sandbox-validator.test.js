 ...
 */
import { validateSandboxConfiguration, validateSandboxPhoneNumber, getSandboxConfigurationSummary } from '../mpesa-sandbox-validator';
describe('M-Pesa Sandbox Validator', () => {
    ...
    describe('validateSandboxConfiguration', () => {
        ...
        it('should reject non-sandbox environment', () => {
            const config = { ...validSandboxConfig, environment: 'production' };

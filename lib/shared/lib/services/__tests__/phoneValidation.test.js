 ...
 */
import { validateKenyanPhoneNumber, isValidKenyanPhoneNumber, normalizeKenyanPhoneNumber, formatKenyanPhoneNumber } from '../phoneValidation';
describe('Phone Number Validation Utility', () => {
    describe('validateKenyanPhoneNumber', () => {
        ...
        test('should reject empty or null input', () => {
            ...
            expect(validateKenyanPhoneNumber(null).isValid).toBe(false);
            expect(validateKenyanPhoneNumber(undefined).isValid).toBe(false);
        });

...
describe('Complete Onboarding API Integration Tests', () => {
    ...
    describe('Existing Venue Migration API Workflows', () => {
        it('should complete venue migration with full API integration', async () => {
            ...
            expect(mockSupabaseClient.rpc).toHaveBeenCalledWith('migrate_existing_venue', { target_bar_id: testBarId });
        ...
        it('should handle migration function failures with proper error handling', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('❌ Venue migration failed:', expect.stringContaining('Migration function failed'));
        });
    });
    ...
    describe('Error Handling and Recovery API Workflows', () => {
        it('should handle database connection failures with proper error responses', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('❌ Onboarding completion failed:', expect.stringContaining('Connection timeout'));
        });
        ...
        it('should handle audit logging failures gracefully', async () => {
            ...
            expect(console.warn).toHaveBeenCalledWith(expect.stringContaining('Audit logging failed'), expect.any(Object));
        });
    });

...
describe('MpesaAuditLogger', () => {
    ...
    describe('logPaymentEvent', () => {
        ...
        it('should redact callback data phone numbers', async () => {
            ...
            const phoneItem = callbackData.Body.stkCallback.CallbackMetadata.Item.find((item) => item.Name === 'PhoneNumber');
        ...
        it('should handle database errors gracefully', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('Failed to create M-Pesa audit log:', expect.objectContaining({
                action: 'payment_initiated',

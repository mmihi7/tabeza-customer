 ...
 */
import { checkOnboardingStatus, completeOnboarding, updateVenueConfiguration, migrateExistingVenue, saveOnboardingProgress, restoreOnboardingProgress, clearOnboardingProgress, createOnboardingErrorMessage, validateOnboardingPrerequisites } from '../onboarding-operations';
...
describe('Onboarding Operations Service', () => {
    ...
    describe('updateVenueConfiguration', () => {
        it('should update venue configuration with valid change', async () => {
            ...
            const result = await updateVenueConfiguration(mockSupabaseClient, '123', currentConfig, {
                venue_mode: 'venue',
                authority_mode: 'pos'
            });
            expect(result.success).toBe(true);
    ...
    describe('Progress Management', () => {
        describe('saveOnboardingProgress', () => {
            it('should save progress to localStorage', () => {
                ...
                expect(mockLocalStorage.setItem).toHaveBeenCalledWith('tabeza_onboarding_progress_123', JSON.stringify(progress));
            });

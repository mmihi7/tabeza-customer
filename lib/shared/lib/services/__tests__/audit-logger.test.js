 ...
 */
import { AuditLogger, getAuditLogger, logOnboardingCompletion, logConfigurationChange, logValidationFailure } from '../audit-logger';
...
describe('AuditLogger', () => {
    ...
    describe('Error Handling', () => {
        it('should handle database insertion errors gracefully', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('Failed to create configuration audit log:', expect.objectContaining({
                action: 'onboarding_completed',
        ...
        it('should handle unexpected errors during logging', async () => {
            ...
            // Should not throw an error
            await expect(auditLogger.logOnboardingCompletion(onboardingData)).resolves.not.toThrow();
            expect(consoleSpy).toHaveBeenCalledWith('Error creating configuration audit log:', expect.objectContaining({
                action: 'onboarding_completed',

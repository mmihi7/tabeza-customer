 ...
 */
import { getOAuthToken, refreshOAuthToken, clearTokenCache, getTokenCacheStats, MpesaOAuthError, } from '../mpesa-oauth';
// Mock fetch
...
describe('M-Pesa OAuth Token Service', () => {
    ...
    describe('getOAuthToken', () => {
        it('should request new token when cache is empty', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials', {
                method: 'GET',
                headers: {

...
export class NetworkStatusManager {
     ...
     */
    async testConnectivity(url = '/api/health', timeout = 5000) {
        try {
    ...
    checkAndUpdateStatus() {
        ...
        const hasChanged = newStatus.isOnline !== this.currentStatus.isOnline ||
 ...
 */
export function getNetworkStatusManager(options) {
 ...
 */
export async function testConnectivity(url, timeout) {

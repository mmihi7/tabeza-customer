 ...
 * - +254712345678 → 254712345678
 */
function normalizeToInternationalFormat(phoneNumber) {
 ...
 */
function formatPhoneNumberForDisplay(normalizedPhone) {
 ...
 * Returns format: +254 XXX XXX XXX
 */
export function formatKenyanPhoneNumber(phoneNumber) {
 ...
 */
export function formatPhoneNumberInput(newValue, previousValue = '') {
 ...
 */
export function getPhoneNumberGuidance(phoneNumber) {

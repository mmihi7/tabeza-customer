...
class BrowserCapabilityDetectorImpl {
    constructor() {
 ...
 */
export function createBrowserCapabilityDetector() {
 ...
 */
export async function detectBrowserCapabilitiesAsync() {
    const detector = createBrowserCapabilityDetector();

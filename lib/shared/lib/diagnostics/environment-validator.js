...
export class EnvironmentValidator {
     ...
     */
    validateSingleVariable(variable) {
     ...
     */
    compareEnvironments(devEnv, prodEnv) {
        const comparisons = [];
        for (const variable of this.variables) {
     ...
     */
    validateEncryptionKeyFormat(key) {
        const errors = [];
        if (!key) {

 ...
 */
export function categorizeError(error, context = 'customer') {
    ...
    if (error.code === '42501' ||
        ...
        return {
            ...
            retryable: false,
            troubleshooting: context === 'customer'
 ...
 */
export function createErrorLogEntry(error, options) {
 ...
 * @returns User-friendly error message
 */
export function formatErrorForUser(error, context = 'customer') {
